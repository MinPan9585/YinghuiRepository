...
namespace Minimalist
{
    ...
    public class MinimalistStandardEditor : ShaderGUI
    {
        ...
        private void InitializeMatProps(MaterialProperty[] _props)
        {
            ...
            _MainTexture = FindProperty("_BaseMap", _props, false) ?? FindProperty("_MainTexture", _props);
            _MainTexturePower = FindProperty("_BaseMapPower", _props, false) ?? FindProperty("_MainTexturePower", _props);
