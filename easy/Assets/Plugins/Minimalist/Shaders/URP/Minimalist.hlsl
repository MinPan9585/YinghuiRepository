    ...
    half4 frag(vertexOutput input): SV_Target
    {
        ...
        #if TEXTUREMODULE_ON
            half4 _MainTexture_var = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, input.uv) + half4(_BaseMapPower, _BaseMapPower, _BaseMapPower, 0);
        ...
        //Realtime Shadow
            ...
            half shadow = pow(abs(max(0.0, NdotL) * attenuation), _ShadowInfluence);
